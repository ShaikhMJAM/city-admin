...
import { MsMessageConfigMetadata } from "./metaData";
...
const MsMessageConfigForm: FC<{
  isDataChangedRef: any;
  closeDialog?: any;
  formView?: string;
  refetch?: any;
}> = ({ isDataChangedRef, closeDialog, formView, refetch }) => {
  ...
  const mutation = useMutation(
    updateAUTHDetailDataWrapperFn(API.updMsMessageConfigFormData),
  ...
  const masterMetadata: MetaDataType = useMemo(
    () => extractMetaData(MsMessageConfigMetadata, formView),
    [MsMessageConfigMetadata, formView, ""]
  ) as MetaDataType;
  return (
    <>
      <FormWrapper
        key={"MsMessageConfigForm"}
...
export const MsMessageConfigFormWrapper = ({
  handleDialogClose,
  isDataChangedRef,
  formView,
  refetch,
