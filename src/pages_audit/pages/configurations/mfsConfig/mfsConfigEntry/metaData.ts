  ...
  fields: [
    {
      ...
      defaultOptionLabel: "Select MFS Service",
      type: "text",
      isReadOnly: false,
      required: true,
      options: () => GetMiscValue(),
      _optionsKey: "GetMiscValue-MFS_TYPE",
      disableCaching: true,
      schemaValidation: {
        type: "string",
    ...
    },
    {
      ...
      name: "MAX_DAY_LIMIT",
      label: "Per day max add money in beneficiary",
      placeholder: "Enter Per day max add money in beneficiary",
      type: "text",
      required: true,
      schemaValidation: {
        type: "string",
        rules: [
          {
            name: "required",
            params: ["Per day max add money in beneficiary is required."],
          },
        ],
      },
      GridProps: {
