...
import { ObjectMappingKeys, utilFunction } from "components/utils";
...
import { TranParticularsWrapper } from "../../serviceWiseConfig/tranParticulers";
...
const BillerChargeConfig: FC<{
  ...
  const onSaveTranParticulars = (tranParticulars) => {
    isTranparticularRef.current = {
      ...isTranparticularRef.current,
      TRN_PERTICULERS: tranParticulars?.finacle1,
      TRN_PERTICULERS2: tranParticulars?.finacle2,
      ABABIL_TRN_PERTICULERS: tranParticulars?.ababil1,
      ABABIL_TRN_PERTICULERS2: tranParticulars?.ababil2,
      TRANZWARE_TRN_PERTICULERS: tranParticulars?.tranzware1,
      TRANZWARE_TRN_PERTICULERS2: tranParticulars?.tranzware2,
    };
  ...
  useEffect(() => {
    isTranparticularRef.current = ObjectMappingKeys(
      ...
      "TRN_PERTICULERS",
      "TRN_PERTICULERS2",
      "ABABIL_TRN_PERTICULERS",
      "ABABIL_TRN_PERTICULERS2",
      "TRANZWARE_TRN_PERTICULERS",
      "TRANZWARE_TRN_PERTICULERS2"
    );
  }, [mainData?.[0]]);
            ...
            <Grid item xs={12} sm={12} md={12}>
              <FormWrapper
                ...
                onFormButtonClickHandel={
                  formMode === "view"
                    ? onConfirmFormButtonClickHandel
                    : onFormButtonClickHandel
                }
              >
                        ...
                        <Button
                          onClick={() => {
                            ...
                            if (Boolean(mainData?.[0]?.SUB_CATEGORY_ICON)) {
                              ...
                              filesdata.current.subCategoryImg =
                                mainData?.[0]?.SUB_CATEGORY_ICON;
                              fileURL.current.subCategoryImg =
                                mainData?.[0]?.SUB_CATEGORY_ICON;
                            } else {
