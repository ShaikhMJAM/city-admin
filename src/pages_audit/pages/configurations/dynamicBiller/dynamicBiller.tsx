...
import { DynBillerScreenNotesWrapper } from "./billerScreenNotes/dynBillerScreenNotes";
...
const actions: ActionTypes[] = [
  ...
  {
    actionName: "screen-notes",
    actionLabel: "Screen Notes",
    multiple: true,
    rowDoubleClick: false,
  },
  {
