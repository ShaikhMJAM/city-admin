    ...
    fields: [
      {
        ...
        required: true,
        maxLength: 10,
        defaultOptionLabel: "Select Operator Type",
  ...
  detailsGrid: {
    ...
    columns: [
      ...
      },
      {
        ...
        defaultOptionLabel: "Select Option Type",
        sequence: 2,
        alignment: "left",
        autoComplete: "off",
        width: 120,
      ...
      },
      {
        ...
        placeholder: "Enter Trn. Particulars",
        sequence: 7,
        autoComplete: "off",
        alignment: "left",
        width: 200,
      ...
      },
      {
        ...
        columnName: "Trn. Particulars2",
        componentType: "editableTextField",
        placeholder: "Enter Trn. Particulars2",
        sequence: 8,
        autoComplete: "off",
        alignment: "left",
        width: 200,
      ...
      },
      {
        ...
        defaultOptionLabel: "Select Charge Template",
        sequence: 9,
        alignment: "center",
        width: 180,
        maxWidth: 250,
    ...
    },
    {
      ...
      validation: (value, data, prev) => {
        if (Array.isArray(prev)) {
          ...
          let ls_msg = "";
          prev.forEach((item, index) => {
            if (value === item?.SPECIAL_AMT) {
              lb_error = true;
              ls_msg = "Amount Label Already entered at Line " + (index + 1);
              return ls_msg;
            }
          });
          if (lb_error) {
