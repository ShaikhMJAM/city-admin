...
import { ServMobileValidFormMetadata } from "./metaData";
...
const ServMobileValidMst: FC<{
  ...
  const mutation = useMutation(
    updateAUTHDetailDataWrapperFn(API.updServMobileValidFormData),
  ...
  const masterMetadata: MetaDataType = useMemo(
    () => extractMetaData(ServMobileValidFormMetadata, formView),
    [ServMobileValidFormMetadata, formView, ""]
  ) as MetaDataType;
  return (
    <>
      <FormWrapper
        key={"ServMobileValidMst"}
...
export const ServMobileValidMstWrapper = ({
  handleDialogClose,
  isDataChangedRef,
  formView,
}) => {
