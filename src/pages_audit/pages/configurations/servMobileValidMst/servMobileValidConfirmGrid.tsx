...
const MobileValidConfirm = () => {
  ...
  const { data, isLoading, isFetching, isError, error, refetch } = useQuery<
    any,
    any
  >(["getServMobileValidGridData", "N", "CONFIRM"], () =>
    API.getServMobileValidGridData("N", "CONFIRM")
  );

  const result = useMutation(API.confirmServMobilValidReq, {
  ...
  useEffect(() => {
    return () => {
      queryClient.removeQueries(["getServMobileValidGridData", "N", "CONFIRM"]);
    };
  }, [getEntries]);
  ServMobileValidGridMetaData.gridConfig.gridLabel =
    "Service Wise Mobile Number Validation Confirmation";
...
export default MobileValidConfirm;
