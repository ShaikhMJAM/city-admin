...
const BranchMasterForm: FC<{
  ...
  const onSubmitHandler: SubmitFnType = (
    ...
    if (!(formView === "add")) {
      ...
      newData["CHQ_BOOK_ENABLED"] = Boolean(newData["CHQ_BOOK_ENABLED"])
        ? "Y"
        : "N";
      newData["DPS_ENABLED"] = Boolean(newData["DPS_ENABLED"]) ? "Y" : "N";
      newData["FD_ENABLED"] = Boolean(newData["FD_ENABLED"]) ? "Y" : "N";
      newData["PAY_ORDER_ENABLED"] = Boolean(newData["PAY_ORDER_ENABLED"])
        ? "Y"
        : "N";
      newData["BR_OPEN_DT"] = Boolean(newData["BR_OPEN_DT"])
        ? format(new Date(newData["BR_OPEN_DT"]), "dd/MMM/yyyy")
        : "";

      upd["_OLDROWVALUE"] = {
        ...upd["_OLDROWVALUE"],
        ACTIVE: Boolean(upd["_OLDROWVALUE"]?.ACTIVE) ? "Y" : "N",
        CHQ_BOOK_ENABLED: Boolean(upd["_OLDROWVALUE"]?.CHQ_BOOK_ENABLED)
          ? "Y"
          : "N",
        ALLOW_RELEASE: Boolean(upd["_OLDROWVALUE"]?.ALLOW_RELEASE) ? "Y" : "N",
        DPS_ENABLED: Boolean(upd["_OLDROWVALUE"]?.DPS_ENABLED) ? "Y" : "N",
        FD_ENABLED: Boolean(upd["_OLDROWVALUE"]?.FD_ENABLED) ? "Y" : "N",
        PAY_ORDER_ENABLED: Boolean(upd["_OLDROWVALUE"]?.PAY_ORDER_ENABLED)
          ? "Y"
          : "N",
      };
