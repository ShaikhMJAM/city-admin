...
const ServiceWiseConfigViewEdit: FC<{
  ...
  if (defaultView === "confirm") {
    ServiceWiseConfigMetadata.form.label =
      "Service Wise Confirmation : " + trntype + "(" + disptrntype + ")";
  } else {
    ServiceWiseConfigMetadata.form.label =
      "Service Wise Configuration : " + trntype + "(" + disptrntype + ")";
  }
  if (result.isSuccess) {
    ...
    <>
      ...
      {openAccept ? (
        <PopupMessageAPIWrapper
          ...
          onActionYes={(rowVal) => onSavePopupYes(rowVal)}
          onActionNo={() => onActionCancel()}
    ...
    <>
      ...
      >
        <ServiceWiseConfigViewEdit
          ...
          disptrntype={rows[0]?.data.DISP_TRN_TYPE + ""}
