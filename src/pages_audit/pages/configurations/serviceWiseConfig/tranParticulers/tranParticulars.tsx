...
const TranParticulars: FC<{
  ...
  const [tranParticulars, SetTranParticulars] = useState(
    buttonName === "TRAN_PARTICULARS_BTN_0"
      ...
      : buttonName === "TRAN_PARTICULARS_BTN"
      ? {
          finacle1: rows?.TRN_PERTICULERS,
          finacle2: rows?.TRN_PERTICULERS2,
          ababil1: rows?.ABABIL_TRN_PERTICULERS,
          ababil2: rows?.ABABIL_TRN_PERTICULERS2,
          tranzware1: rows?.TRANZWARE_TRN_PERTICULERS,
          tranzware2: rows?.TRANZWARE_TRN_PERTICULERS2,
        }
      : {}
  );
          ...
          <Grid item xs={2} sm={6} md={2} style={{ paddingRight: "10px" }}>
            ...
            >
              <Toolbar className={headerClasses.toolBar} variant={"dense"}>
                <Typography
                  className={headerClasses.title2}
                  color="inherit"
                  variant={"h6"}
                  component="div"
                >
