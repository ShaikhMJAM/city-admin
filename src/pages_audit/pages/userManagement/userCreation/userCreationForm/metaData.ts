...
export const UserCreationFormMetadata = {
  form: {
    name: "userCreateForm",
    label: "Admin Panel User Maintenance",
  ...
  fields: [
    ...
    },
    {
      ...
      autoComplete: "off",
      defaultOptionLabel: "Select User Level",
      options: [
        { label: "ADMIN", value: "4" },
        { label: "HEAD", value: "3" },
    ...
    },
    {
      ...
      schemaValidation: {
        type: "string",
        rules: [{ name: "required", params: ["New Password is required"] }],
      },
      validate: (currentField, value) => {
        if (!Boolean(currentField?.value)) {
          ...
          return "Password should be alphanumeric and have at least one special character, one lowercase character, one uppercase character without any space in between.";
        }
        return "";
      },
    ...
    },
    {
      ...
      schemaValidation: {
        type: "string",
        rules: [{ name: "required", params: ["Confirm Password is required"] }],
      },
...

    {
      ...
      label: "Group Name",
      placeholder: "",
      defaultOptionLabel: "Select Group Name",
      type: "text",
      required: true,
      options: () => {
    ...
    },
    {
      ...
      label: "User Sub Type",
      placeholder: "",
      defaultOptionLabel: "Select User Sub Type",
      options: () => {
    ...
    },
    {
      ...
      placeholder: "",
      defaultOptionLabel: "Select Notification Template",
      options: () => {
