        ...
        {isQRVerifyFlow ? (
          <>
            <div style={{ width: "100%", height: "100%" }}>
              ...
              <Grid
                container
                style={{ marginRight: 10, marginLeft: 10, width: "97%" }}
                spacing={0}
              >
                <Grid item lg={12} md={12} xl={12} xs={12}>
                  ...
                  <Typography component={"ol"} variant={"caption"}>
                    <Typography component={"li"}>
                      {
                        "Scan QR code: Use any authenticator app to scan the provided QR code."
                      }
                    </Typography>
                    <Typography component={"li"}>
                      {
                        "Enable two-factor authentication: Utilize the Time-based One-Time Password (TOTP) method for enhanced security."
                      }
                    </Typography>
                    <Typography component={"li"}>
                      {
                        "Authenticator app options: You can choose any authenticator app, but Google Authenticator is recommended."
                      }
                    </Typography>
                    <Typography component={"li"}>
                      {
                        "Scan QR code instruction: Instruct the user to scan the QR code in their chosen authenticator app."
                      }
                    </Typography>
                    <Typography component={"li"}>
                      {
                        "Verify OTP: After scanning, the user should verify the One-Time Password (OTP) generated by the app."
                      }
                    </Typography>
                  </Typography>
